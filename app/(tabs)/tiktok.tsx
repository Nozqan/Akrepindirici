...
import { DownloadManager } from '@/lib/download-manager';
  ...
  const handleDownload = async () => {
    if (!url) {
      Alert.alert('Hata', 'Lütfen bir TikTok linki girin');
      return;
    }

    if (!DownloadManager.validateUrl(url, 'tiktok')) {
      Alert.alert('Hata', 'Geçersiz TikTok linki');
      return;
    }
    ...
    try {
      ...
      const filename = DownloadManager.generateFilename('tiktok', '1080p');

      await DownloadManager.addDownloadHistory({
        id: videoId,
        platform: 'tiktok',
        url,
        title: 'TikTok Video (Filigran Temizlendi)',
        filename,
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="gap-6">
          ...
          <View className="gap-2">
            ...
            <TextInput
              placeholder="https://www.tiktok.com/... veya https://vm.tiktok.com/..."
